...
def _storeMissionPlan(pMissionPlan):
    ...
    try:
        ...
        res = requests.put('http://localhost:9200/mission_plan_manager/MissionPlans/'+str(missionid)+'/_create',json.dumps(pMissionPlan))
...
def _updateMissionPlan(pMissionPlan):
    ...
    try:
        ...
        res = requests.post('http://localhost:9200/mission_plan_manager/MissionPlans/'+str(missionid)+"/_update",json.dumps(missiondoc))
